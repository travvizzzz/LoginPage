    ...
    <div className="bg-gray-700">
      ...
      <section className="flex p-7">
        <div className="flex-1 pr-5 p-20 ">
          <p className="text-4xl font-bold text-slate-400">Build anything</p>
          <p className="text-4xl font-bold  text-slate-400">Using programming.</p>
          <br />
          ...
          <p className="text-lg font-semibold text-slate-400">About programming Languages</p>
          <br />
          <p className="text-sm text-slate-200">
      ...
      <section className="flex p-4 bg-gray-900">
        <div className="w-1/2 font-bold text-3xl pr-7 m-4 ml-16 text-slate-400">
          About Developing Guys who create technology
          <br />
          <br />
          <p className="font-semibold text-lg text-slate-200">Front-End</p>
          <p className="text-sm text-slate-200">
        ...
        <div className="flex-1 flex flex-col items-ed w-100 h-100 rounded-lg ">
          <img
            ...
            alt="A depiction of computer programming"
            className="ml-48 w-80 h-80 m-5 object-cover border-4  border-slate-200 rounded-sm"
          />
        </div>
      </section>
      <section className="">
        <section className="flex justify-center ">
          <div className="flex flex-row m-5 p-2  items-center space-x-5">
            <p className="border-2 bg-gray-900 font-semibold border-gray-300 rounded-lg px-6 py-12 text-gray-700 hover:bg-gray-500 hover:text-white transition ">
              <img width={100} height={50} src="image/border11.jpg"></img>
              <p className="text-slate-200">Join a Community</p>
            </p>
            <p className="border-2 bg-gray-900 font-semibold border-gray-300 rounded-lg px-6 py-12  text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={50} height={20} src="image/border12.jpg"></img>
              <p className="text-slate-200">Developer Forums</p>
            </p>
            <p className="border-2 font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={90} height={50} src="image/border3.jpg"></img>
            <p className="text-slate-200">Development Slack</p>
            </p>
            <p className="border-2 font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={85} height={50} src="image/border14.jpg"></img>
             <p className="text-slate-200"> @ShopifyDevs on IG</p>
            </p>
          </div>
        </section>
        <section className="flex justify-center ">
          <div className="flex flex-row m-5 p-2  items-center space-x-5">
            <p className="border-2 font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition ">
              ...
              <p className="text-slate-200">Developer Change</p>
            </p>
            <p className="border-2  font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={50} height={50} src="image/border16.jpg"></img>
             <p className="text-slate-200"> YouTube Channels</p>
            </p>
            <p className="border-2 font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={100} height={50} src="image/border17.jpg"></img>
            <p className="text-slate-200">  @Telegram Channel</p>
            </p>
            <p className="border-2 font-semibold border-gray-300 rounded-lg px-6 py-12 bg-gray-900 text-gray-700 hover:bg-gray-500 hover:text-white transition">
              <img width={100} height={20} src="image/border18.jpg"></img>
              <p className="text-slate-200">Facebook Live Vlogs</p>
            </p>
          </div>
        </section>
      </section>
      ...
      <section className="flex justify-center space-x-16 p-14 bg-gray-950">
        <div>
          <p className="font-semibold text-xs text-white">New and updates</p>
          <br></br>
        ...
        <div>
          <p className="font-semibold text-xs text-white">Blogs</p>
          <br />
        ...
        <div>
          <p className="font-semibold text-xs text-white">Community</p>
          <br />
        ...
        <div>
          <p className="font-semibold text-xs text-white">Social</p>
          <br />
          <p className="font-light text-zinc-400 text-sm">Facebook</p>
        ...
        <div>
          <p className="font-semibold text-xs text-white">Eventes</p>
          <br />
        ...
        <div>
          <p className="font-semibold text-xs text-white">Legal</p>
          <br />
